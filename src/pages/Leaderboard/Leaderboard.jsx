...
const Leaderboard = () => {
    ...
    useEffect(() => {
        ...
        if (today.getMonth() === 11) {
            // If it's December, set the end of the month to December 31st of the current year
            endOfMonth = new Date(today.getFullYear(), 11, 31, 23, 59, 59);
        } else if (today.getMonth() === 1 && ((today.getFullYear() % 4 === 0 && today.getFullYear() % 100 !== 0) || today.getFullYear() % 400 === 0)) {
            // If it's February and the current year is a leap year, set the end of February to February 29th
            endOfMonth = new Date(today.getFullYear(), 1, 29, 23, 59, 59);
        } else {
            // For other months, set the end of the month to the last day of the next month
